...
public class LogFilter implements Filter {
    ...
    private boolean isIgnoredWords(String word, List<String> excludedWords) {
        for (String excludeWord : excludedWords) {
            if (word.toLowerCase().contains(excludeWord)) return true;
        }
        return false;
    }
    ...
    private String logInfo(HttpServletRequest req) {
        ...
        while (parameterNames.hasMoreElements()) {
            ...
            if (isIgnoredWords(paramName, excludedWords)) continue;
